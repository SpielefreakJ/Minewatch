...
public class EntityDVaBullet extends EntityMW {

	public EntityDVaBullet(World worldIn) {
		this(worldIn, null, -1);
	}

	public EntityDVaBullet(World worldIn, EntityLivingBase throwerIn, int hand) {
